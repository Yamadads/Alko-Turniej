...
from .views import Index, NewTournament, my_tournaments_organizer, my_tournaments_organizer_history, \
    my_tournaments_participant, tournament_site, tournament_join, my_tournaments_participant_history
...
urlpatterns = [
    ...
    url(r'^AlkoTurniej/uczestnicze/historia', my_tournaments_participant_history, name='my_tournaments_participant_history'),
